      ...
      <div className="container px-4 sm:px-6 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            ...
            >
              Connect with IIITL Aluminis who can vouch for you at top companies and
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">1000+ Referrals</span>
              </div>
              <div className="flex items-center gap-2">
                <Icons.checkCircle className="h-5 w-5 text-emerald-600 dark:text-emerald-400" />
                <span className="text-sm font-medium">20+ Companies</span>
              </div>
              <div className="flex items-center gap-2">
                <Icons.checkCircle className="h-5 w-5 text-emerald-600 dark:text-emerald-400" />
                <span className="text-sm font-medium">70% Success Rate</span>
              </div>
            </motion.div>
          </motion.div>
          <motion.div
