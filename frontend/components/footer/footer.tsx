          ...
          <div className="col-span-2 space-y-4 md:col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <p>
                Built by{" "}
                <Link
                  href="https://www.linkedin.com/in/sarthak-kumar-9a0189357/"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                The open-source platform for connecting with Aluminis.
              </p>
            </ul>
          </div>
        </div>
